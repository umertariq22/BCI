        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                    <li><Link href={AppRoutes.HOME} className="text-gray-800 hover:text-gray-900">Home</Link></li>
                    <li><Link href={AppRoutes.ABOUT} className=" text-gray-800 hover:text-gray-900">About Us</Link></li>
                    <li><Link href={AppRoutes.HOW_IT_WORKS} className=" text-gray-800 hover:text-gray-900">How it Works?</Link></li>
                    <li><Link href={AppRoutes.CONTACT} className=" text-gray-800 hover:text-gray-900">Contact Us</Link></li>
                </ul>
                ...
                <span className="text-lg text-gray-500 text-center block">©<Link href="https://pagedone.io/">Brain Computer Interface</Link> {currentYear}, All rights reserved.</span>
            </div>
        </div>
    </footer>                               
  );
